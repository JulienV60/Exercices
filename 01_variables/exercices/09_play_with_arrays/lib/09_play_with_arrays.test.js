...
describe("#first", () => {
  ...
  test("Should be binded to the index 0 of the variable digits", () => {
    return studentCode.then((code) => {
      const changedStudentCode = code.replace(new RegExp("(let|const) first"), "digits[0] = true; $&");
...
describe("#last", () => {
  ...
  test("Should be binded to the index 9 of the variable digits", () => {
    return studentCode.then((code) => {
      const changedStudentCode = code.replace(new RegExp("(let|const) last"), "digits[9] = true; $&");
...
describe("#sixth", () => {
  ...
  test("Should be binded to the index 6 of the variable digits", () => {
    return studentCode.then((code) => {
      const changedStudentCode = code.replace(new RegExp("(let|const) sixth"), "digits[6] = true; $&");
